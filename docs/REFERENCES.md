...
Claves usadas en el frontmatter de los temas. Solo se añaden libros de la lista base (`PLAN.md` §2) y artículos revisados. Verificar edición y capítulo antes de usar una clave; los capítulos indicados aquí deben confirmarse contra la edición disponible (ticket de docs al primer uso).
...
| young-freedman-5 | Ídem. Cap. 5, "Aplicación de las leyes de Newton". |
| young-freedman-6 | Ídem. Cap. 6, "Trabajo y energía cinética". |
...
| serway-10 | Ídem. Cap. 10, "Rotación de un objeto rígido en torno a un eje fijo". |
| siegwart-2 | Siegwart, R., Nourbakhsh, I. y Scaramuzza, D. *Introduction to Autonomous Mobile Robots*, 2.ª ed. Cap. 2, "Locomotion". |
| siegwart-3 | Ídem. Cap. 3, "Mobile Robot Kinematics". |
| siegwart-4 | Ídem. Cap. 4, "Perception". |
| corke-4 | Corke, P. *Robotics, Vision and Control*, 2.ª ed. Cap. 4, "Mobile Robot Vehicles". |
