...
- Verifica: e1 · "Δx m en Δt s: velocidad media" · Δx ∈ [0.01, 1], Δt ∈ [0.05, 2] · 0.09, 0.1 → **0.9 m/s** · e2 · "x(t) = c·t²: velocidad en t" · c ∈ [0.05, 0.5], t ∈ [1, 5] · c = 0.2, t = 2 → **0.8 m/s** · e3 · "v pasa de v1 a v2 en Δt: aceleración media" · v ∈ [0, 1], Δt ∈ [0.2, 3] · 0.3 → 0.6 en 0.5 s → **0.6 m/s²** · e4 (opcional) · "x(t) = a·t + b·t²: v en t = 3" · a ∈ [0, 1] m/s, b ∈ [0.05, 0.5] m/s², t = 3 s fijo (#252) · a = 0.5, b = 0.1 → **1.1 m/s**.
