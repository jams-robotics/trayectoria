...
// aula.json under `aula` (F3-02a), sims.json under `sims` (F4-01b), urdf.json under
// `urdf` (F3-04: the error keys of docs/ROBOT-SPEC.md §2 and of the upload rules) and
// content.json under `content` (F6-01: the exercise statements, `content.<topicId>.<exerciseId>`).
export const resources = {
  es: { common: { ...es, auth, aula, content, progress, sims, urdf, widgets } },
};
