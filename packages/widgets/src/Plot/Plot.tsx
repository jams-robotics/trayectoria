...
import { readTheme, sameTheme, seriesColor, SERIES_DASHES } from './theme';
 ...
 */
export function usePlotTheme(ref: RefObject<HTMLDivElement | null>): PlotTheme {
...
export function yAxisOf(series: readonly PlotSeries[], t: Translate): PlotAxis {
 ...
 */
function usePlotChart(props: PlotProps, t: Translate): ChartState {
